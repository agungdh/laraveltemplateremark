...
<html class="no-js css-menubar" lang="en">
  ...
  <body class="animsition">
    ...
    <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
      ...
      <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
          <img class="navbar-brand-logo" src="{{ asset('assets') }}/base/images/logo.png" title="Remark">
                        ...
                        <div class="media">
                          <div class="pr-10">
                            <span class="avatar avatar-sm avatar-off">
                              <img src="{{ asset('assets') }}/global/portraits/3.jpg" alt="..." />
                              <i></i>
                            </span>
                          </div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          <div class="pr-10">
                            <span class="avatar avatar-sm avatar-busy">
                              <img src="{{ asset('assets') }}/global/portraits/4.jpg" alt="..." />
                              <i></i>
                            </span>
                          </div>
                          <div class="media-body">
    ...
    <script>Config.set('assets', '{{ asset('assets') }}/base');</script>
