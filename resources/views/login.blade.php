...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets') }}/base/images/apple-touch-icon.png">
    <link rel="shortcut icon" href="{{ asset('assets') }}/base/images/favicon.ico">
    
    <!-- Stylesheets -->
    <link rel="stylesheet" href="{{ asset('assets') }}/global/css/bootstrap.min.css">
    <link rel="stylesheet" href="{{ asset('assets') }}/global/css/bootstrap-extend.min.css">
    <link rel="stylesheet" href="{{ asset('assets') }}/base/css/site.min.css">
    ...
    <link rel="stylesheet" href="{{ asset('assets') }}/global/vendor/flag-icon-css/flag-icon.css">
        <link rel="stylesheet" href="{{ asset('assets') }}/base/examples/css/pages/login-v2.css">
  ...
  <body class="animsition page-login-v2 layout-full page-dark">
    ...
    <div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
      <div class="page-content">
        <div class="page-brand-info">
          <div class="brand">
            <img class="brand-img" src="{{ asset('assets') }}/base/images/logo@2x.png" alt="...">
        ...
        <div class="page-login-main animation-slide-right animation-duration-1">
          <div class="brand hidden-md-up">
            <img class="brand-img" src="{{ asset('assets') }}/base/images/logo-colored@2x.png" alt="...">
    ...
    <script>Config.set('assets', '{{ asset('assets') }}/base/assets');</script>
